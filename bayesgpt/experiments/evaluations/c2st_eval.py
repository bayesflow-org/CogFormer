...
C2ST_DIR = Path("./bayesgpt/experiments/figures/c2st")
OUT_DIR = Path("./bayesgpt/experiments/evaluations")

MODELS = ["DDM", "RDM", "CDM"]
SCENARIOS = ["Family_vs_BF", "Class_vs_Family"]
SCENARIO_LABELS = {
    "Family_vs_BF": r"\textsc{BayesGPT}\textsubscript{Family} vs.\ \textsc{BayesFlow}",
    "Class_vs_Family": r"\textsc{BayesGPT}\textsubscript{Class} vs.\ \textsc{BayesGPT}\textsubscript{Family}",
}
