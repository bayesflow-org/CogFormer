...
SOURCES = ["BayesFlow", "BayesGPT_Family", "BayesGPT_ModelClass"]

SOURCE_LABELS = {
    "BayesFlow": r"\textsc{BayesFlow}",
    "BayesGPT_Family": r"\textsc{BayesGPT}\textsubscript{Family}",
    "BayesGPT_ModelClass": r"\textsc{BayesGPT}\textsubscript{Class}",
}
METRIC_LABELS = {
    "NRMSE": "NRMSE",
...
def main():
    ...
    for model in MODELS:
        ...
        for case in CASES:
            ...
            for source, df in [("BayesFlow", bf), ("BayesGPT_Family", fm_fam), ("BayesGPT_ModelClass", fm_cls)]:
                if df is None:
                    continue
