...
def test(case="fixed"):
    ...
    data_path = Path(f"bayesgpt/experiments/data/rdm_{case}_data.npz")
...
def main():
    ...
    for cfg_name, design_config in benchmark.items():
        ...
        pred_path = pred_dir / f"rdm_families_{cfg_name}_gpt_pred.npz"
        ...
        figpath = outdir / f"rdm_family_{cfg_name}_fm_mixed_recovery.pdf"
        ...
        coverage_path = outdir / f"rdm_family_{cfg_name}_fm_mixed_coverage.pdf"
        ...
        ecdf_path = outdir / f"rdm_family_{cfg_name}_fm_mixed_ecdf.pdf"
...
if __name__ == "__main__":
    ...
    # To use
    # python -m rdm_family_gpt_validate.py \
    # --checkpoint bayesgpt_rdm_fm_eps500_stp200_bse32_nls4_nhs8_nss10.pt \
    # --batch_size 200 \
