...
class BayesGPTTrainer:
    ...
    def train(
        ...
        train_config,
        val_config,
        checkpoint_path="bayesgpt_cdm_fm.pt",
        fig_path="fig.pdf"
    ):
        global_step = 0
        ...
        checkpoint_dir = Path("./bayesgpt/experiments/checkpoints/fm/cdm/")
    ...
    def val_step(self, config, global_step, fig_path):
        ...
        params = ["v", "v_theta", "a", "tau", "s_v", "s_tau"]
        ...
        recovery_dir = Path("./bayesgpt/experiments/figures/fm/cdm/recovery")
        recovery_dir.mkdir(parents=True, exist_ok=True)
        posterior_dir = Path("./bayesgpt/experiments/figures/fm/cdm/test_posterior")
        posterior_dir.mkdir(parents=True, exist_ok=True)
        coverage_dir = Path("./bayesgpt/experiments/figures/fm/cdm/coverage")
        coverage_dir.mkdir(parents=True, exist_ok=True)
        metrics_dir = Path("./bayesgpt/experiments/figures/fm/cdm/metrics")
        ...
        for tag, design_config in scenarios:
            ...
            out_posterior = posterior_dir / Path(f"cdm_benchmark_test_posterior_{tag}.pdf")
            ...
            out_coverage = coverage_dir / Path(f"cdm_benchmark_test_coverage_{tag}.pdf")
            ...
            out_metrics = metrics_dir / Path(f"cdm_benchmark_test_metrics_{tag}.pdf")
...
if __name__ == "__main__":
    ...
    wandb_config = {
        "project_name": "bayesgpt-fm-cdm",
        "run_name": None,
        "tags": ["BayesGPT", "CDM", "ModelFamily"],
        "watch_log": "gradients",
        "watch_freq": 200
    }
