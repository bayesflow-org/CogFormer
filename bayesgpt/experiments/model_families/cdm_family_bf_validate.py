...
def main(case: str, batch_size: int = 200, num_samples: int = 200):
    ...
    for i in range(10):
        ...
        posterior_path = figures_dir / f"cdm_families_bf_{case}_posterior{i}.pdf"
    ...
    recovery_path = figures_dir / f"cdm_families_bf_{case}_recovery.pdf"
    ...
    coverage_path = figures_dir / f"cdm_families_bf_{case}_coverage.pdf"
    ...
    ecdf_path = figures_dir / f"cdm_families_bf_{case}_ecdf.pdf"
