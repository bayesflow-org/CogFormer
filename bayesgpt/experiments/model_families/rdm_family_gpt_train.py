...
class BayesGPTTrainer:
    ...
    def train(
        ...
        train_config,
        val_config,
        checkpoint_path="bayesgpt_rdm_fm.pt",
        fig_path="fig.pdf"
    ):
        # Define global step
        global_step = 0
        ...
        checkpoint_dir = Path("./bayesgpt/experiments/checkpoints/fm/rdm/")
    ...
    def val_step(self, config, global_step, fig_path):
        ...
        recovery_dir = Path("./bayesgpt/experiments/figures/fm/rdm/recovery")
        recovery_dir.mkdir(parents=True, exist_ok=True)
        posterior_dir = Path("./bayesgpt/experiments/figures/fm/rdm/test_posterior")
        posterior_dir.mkdir(parents=True, exist_ok=True)
        coverage_dir = Path("./bayesgpt/experiments/figures/fm/rdm/coverage")
        coverage_dir.mkdir(parents=True, exist_ok=True)
        metrics_dir = Path("./bayesgpt/experiments/figures/fm/rdm/metrics")
...
if __name__ == "__main__":
    ...
    wandb_config = {
        "project_name": "bayesgpt-fm-rdm",
        "run_name": None,
        "tags": ["BayesGPT", "RDM", "ModelFamily", "Designer"],
        "watch_log": "gradients",
        "watch_freq": 200
    }
