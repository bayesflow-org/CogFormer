"""
BayesGPT application to real DDM data (data_application_1.csv).
...
from bayesgpt.utils.plot_utils import bayesgpt_fm_colors, credible_interval
...
def parse_args():
    p = argparse.ArgumentParser(
        description="Run BayesGPT inference on data_application_1.csv"
    )
    p.add_argument("--checkpoint", type=str, required=True,
                   help="Path to trained BayesGPT checkpoint")
    p.add_argument("--data", type=str, default="data/data_application_1.csv",
                   help="Path to the CSV data file")
    p.add_argument("--outdir", type=str,
                   default="./bayesgpt/experiments/figures/fm/ddm/application_1/",
