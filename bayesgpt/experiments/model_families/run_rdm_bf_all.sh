...
#
# Usage:
#   bash bayesgpt/experiments/model_families/run_rdm_bf_all.sh
#   bash bayesgpt/experiments/model_families/run_rdm_bf_all.sh --epochs 500 --batch_size 128
#
...
for case in "${CASES[@]}"; do
    ...
    echo "------------------------------------------"
    python -m bayesgpt.experiments.model_families.rdm_family_bf_validate \
        --case "$case"
done
