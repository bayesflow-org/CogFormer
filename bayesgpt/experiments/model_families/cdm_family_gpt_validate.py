...
def check_data_path(data_path: str | None, case: str) -> Path | None:
    ...
    if p.is_dir():
        return p / f"cdm_families_bf_{case}_data.npz"
...
def parse_args():
    ...
    p.add_argument("--outdir", type=str, default="./bayesgpt/experiments/figures/fm/cdm/", help="Output directory")
...
def test(case="fixed"):
    ...
    data_path = Path(f"bayesgpt/experiments/data/cdm_{case}_data.npz")
...
def main():
    ...
    for cfg_name, design_config in benchmark.items():
        ...
        pred_path = outdir / f"cdm_families_{cfg_name}_gpt_pred.npz"
        ...
        figpath = outdir / f"cdm_families_{cfg_name}_fm_mixed_m_recovery.pdf"
        ...
        coverage_path = outdir / f"cdm_families_{cfg_name}_fm_mixed_m_coverage.pdf"
        ...
        metrics_fig_path = outdir / f"cdm_families_{cfg_name}_fm_mixed_m_metrics.pdf"
        ...
        metrics_csv_path = outdir / f"cdm_families_{cfg_name}_fm_mixed_m_metrics.csv"
        ...
        for i in range(10):
            ...
            posterior_path = outdir / f"cdm_families_{cfg_name}_fm_mixed_m_posterior{i}.pdf"
...
if __name__ == "__main__":
    ...
    # --checkpoint bayesgpt/experiments/checkpoints/fm/cdm/bayesgpt_cdm_mixed_attn_....pt \
    # --batch_size 200 \
