...
#
# Usage:
#   bash experiments/model_families/run_family_bf_all.sh --model_family ddm
#   bash experiments/model_families/run_family_bf_all.sh --model_family rdm --epochs 500 --batch_size 128
#
...
for case in "${CASES[@]}"; do
    ...
    echo "------------------------------------------"
    if ! python experiments/model_families/family_bf_train.py \
