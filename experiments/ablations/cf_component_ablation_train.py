...
class CogFormerAblationTrainer:
    def __init__(self, cf, model_family, adapter, ablation, use_wandb=False, use_amp=False, num_gpus=1):
    ...
    def train(self, train_config, val_config, checkpoint_path="cogformer_ablation.pt", fig_path="fig.pdf"):
        ...
        prefetcher.shutdown()
        checkpoint_dir = Path("./experiments/ablations/component_ablation_data/")
    ...
    def val_step(self, config, global_step, fig_path):
        ...
        pred_dir      = Path("./experiments/ablations/component_ablation_data")
