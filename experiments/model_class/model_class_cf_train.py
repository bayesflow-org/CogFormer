...
from cogformer.utils.plot_utils import cogformer_mf_colors, cogformer_mc_colors, interpolate_palette
...
class CogFormerTrainer:
    ...
    def train(self, train_config, val_config, checkpoint_path="cogformer_model_class_mc.pt", fig_path="fig"):
        global_step = 0
