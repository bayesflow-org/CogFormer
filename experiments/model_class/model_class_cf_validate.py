...
def main():
    ...
    for model_name, model_cfg in all_model_configs.items():
        ...
        for cfg_name, design_config in model_cfg["benchmarks"].items():
            ...
            fig_path = outdir / f"{tag}_mc_recovery.pdf"
            ...
            coverage_path = outdir / f"{tag}_mc_coverage.pdf"
            ...
            ecdf_path = outdir / f"{tag}_mc_ecdf.pdf"
            ...
            metrics_fig_path = outdir / f"{tag}_mc_metrics.pdf"
            ...
            metrics_csv_path = paths.metrics_mirror(outdir, make=True) / f"{tag}_mc_metrics.csv"
            ...
            if not args.skip_posteriors:
                for i in range(10):
                    ...
                    posterior_path = outdir / f"{tag}_mc_posterior_{i}.pdf"
