...
from cogformer.utils.plot_utils import cogformer_mf_colors, interpolate_palette
...
class CogFormerTrainer:
    ...
    def train(self, train_config, val_config, checkpoint_path="cogformer_mf.pt", fig_path="fig.pdf"):
        global_step = 0
    ...
    def plot_amortization_gap(self):
        ...
        palette = interpolate_palette(cogformer_mf_colors(), len(self.amortization_history))
