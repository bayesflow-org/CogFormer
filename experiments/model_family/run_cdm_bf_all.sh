...
#
# Usage:
#   bash experiments/model_family/run_cdm_bf_all.sh
#   bash experiments/model_family/run_cdm_bf_all.sh --epochs 500 --batch_size 128
#
...
for case in "${CASES[@]}"; do
    ...
    echo "------------------------------------------"
    if ! python experiments/model_family/cdm_family_bf_train.py \
            --case "$case" --test; then
    ...
    echo " TRAINING: $case"
    echo "------------------------------------------"
    python experiments/model_family/cdm_family_bf_train.py \
    ...
    echo "------------------------------------------"
    python experiments/model_family/cdm_family_bf_validate.py \
        --case "$case"
done
