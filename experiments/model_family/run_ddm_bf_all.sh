...
for case in "${CASES[@]}"; do
    ...
    echo "------------------------------------------"
    if ! python experiments/model_family/ddm_family_bf_train.py \
            --case "$case" --test; then
    ...
    echo " TRAINING: $case"
    echo "------------------------------------------"
    python experiments/model_family/ddm_family_bf_train.py \
    ...
    echo "------------------------------------------"
    python experiments/model_family/ddm_family_bf_validate.py \
        --case "$case"
done
