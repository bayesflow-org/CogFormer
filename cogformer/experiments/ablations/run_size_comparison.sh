...
# Outputs: cogformer/experiments/ablations/size_comparison_data/
#          cogformer/experiments/ablations/size_comparison_figures/
# ============================================================
...
run_size() {
    ...
    python -m cogformer.experiments.ablations.cf_size_comparison_train \
        --size             "$SIZE" \
        --epochs           "$EPOCHS" \
