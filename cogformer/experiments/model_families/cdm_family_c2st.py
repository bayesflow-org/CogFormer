...
def parse_args():
    ...
    p.add_argument("--outdir", type=str, default="./cogformer/experiments/figures/c2st/cdm/")
...
def main():
    ...
    for cfg_name, design_config in benchmark.items():
        ...
        cf_pred_path = Path(args.cf_pred_dir) / f"cdm_families_{cfg_name}_cf_pred.npz"
        ...
        if args.mc_pred_dir is not None:
            mc_pred_path = Path(args.mc_pred_dir) / f"cdm_{cfg_name}_cf_pred.npz"
