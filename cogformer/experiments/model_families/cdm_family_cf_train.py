...
class CogFormerTrainer:
    ...
    def train(
        ...
        train_config,
        val_config,
        checkpoint_path="cogformer_cdm_fm.pt",
        fig_path="fig.pdf"
    ):
        global_step = 0
    ...
    def val_step(self, config, global_step, fig_path):
        ...
        recovery_dir = Path("./cogformer/experiments/figures/fm/cdm/recovery")
        recovery_dir.mkdir(parents=True, exist_ok=True)
        posterior_dir = Path("./cogformer/experiments/figures/fm/cdm/test_posterior")
        posterior_dir.mkdir(parents=True, exist_ok=True)
        coverage_dir = Path("./cogformer/experiments/figures/fm/cdm/coverage")
        coverage_dir.mkdir(parents=True, exist_ok=True)
        metrics_dir = Path("./cogformer/experiments/figures/fm/cdm/metrics")
...
if __name__ == "__main__":
    ...
    wandb_config = {
        "project_name": "cogformer-fm-cdm",
        "run_name": None,
        "tags": ["CogFormer", "CDM", "ModelFamily"],
        "watch_log": "gradients",
        "watch_freq": 200
    }
