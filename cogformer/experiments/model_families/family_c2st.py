...
FAMILY_REGISTRY = {
    "ddm": {
        ...
        "outdir_default": "./cogformer/experiments/figures/c2st/ddm/",
        "bf_data_stem": "ddm",
    ...
    "rdm": {
        ...
        "outdir_default": "./cogformer/experiments/figures/c2st/rdm/",
        "bf_data_stem": "rdm",
    ...
    "cdm": {
        ...
        "outdir_default": "./cogformer/experiments/figures/c2st/cdm/",
        "bf_data_stem": "cdm",
...
def main():
    ...
    summary_path = Path(outdir_root) / reg["summary_name"]
