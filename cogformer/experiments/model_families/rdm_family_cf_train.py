...
class CogFormerTrainer:
    ...
    def train(
        ...
        train_config,
        val_config,
        checkpoint_path="cogformer_rdm_fm.pt",
        fig_path="fig.pdf"
    ):
        # Define global step
        global_step = 0
        ...
        prefetcher.shutdown()
        checkpoint_dir = Path("./cogformer/experiments/checkpoints/fm/rdm/")
    ...
    def val_step(self, config, global_step, fig_path):
        ...
        params = ["v", "v_diff", "a", "tau", "s_v", "s_tau"]
        ...
        recovery_dir = Path("./cogformer/experiments/figures/fm/rdm/recovery")
        recovery_dir.mkdir(parents=True, exist_ok=True)
        posterior_dir = Path("./cogformer/experiments/figures/fm/rdm/test_posterior")
        posterior_dir.mkdir(parents=True, exist_ok=True)
        coverage_dir = Path("./cogformer/experiments/figures/fm/rdm/coverage")
        coverage_dir.mkdir(parents=True, exist_ok=True)
        metrics_dir = Path("./cogformer/experiments/figures/fm/rdm/metrics")
        ...
        for tag, design_config in scenarios:
            ...
            out_posterior = posterior_dir / Path(f"rdm_benchmark_test_posterior_{tag}.pdf")
            ...
            out_coverage = coverage_dir / Path(f"rdm_benchmark_test_coverage_{tag}.pdf")
            ...
            out_metrics = metrics_dir / Path(f"rdm_benchmark_test_metrics_{tag}.pdf")
...
if __name__ == "__main__":
    ...
    wandb_config = {
        "project_name": "cogformer-fm-rdm",
        "run_name": None,
        "tags": ["CogFormer", "RDM", "ModelFamily", "Designer"],
        "watch_log": "gradients",
        "watch_freq": 200
    }
