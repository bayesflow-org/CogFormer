...
def parse_args():
    ...
    p.add_argument("--outdir", type=str, default="./cogformer/experiments/figures/fm/ddm/", help="Output directory")
...
def test(case="fixed"):
    ...
    data_path = Path(f"cogformer/experiments/data/ddm_{case}_data.npz")
...
def main():
    ...
    for cfg_name, design_config in benchmark.items():
        ...
        pred_path = pred_dir / f"ddm_family_{cfg_name}_cf_pred.npz"
...
if __name__ == "__main__":
    ...
    # To use
    # python -m ddm_family_cf_fm_validate.py \
    # --checkpoint cogformer_fm_eps500_stp200_bse32_nls4_nhs8_nss10.pt \
    # --batch_size 200 \
