...
CASE_CONFIGS = {
    ...
    "fixed": {
        ...
        "flatten_param_outputs": False,
        "squeeze_outputs": True,
        "expected_num_active": 4,  # v, a, z, tau
    },
    "regressed": {
        "free_intrinsics": ["v", "a", "z", "tau", "s_v", "s_tau"],
        "fixed_intrinsics": [],
        ...
        "expected_num_active": 12,  # 6 intercepts + 3 u_1 + 3 u_2
    },
    "fixed_regressed": {
        "free_intrinsics": ["v", "a", "z", "tau"],
        "fixed_intrinsics": ["s_v", "s_tau"],
        ...
        "flatten_param_outputs": True,
        "squeeze_outputs": False,
        "expected_num_active": 10,  # 4 intercepts (v, a, z, tau) + 3 u_1 + 3 u_2
    },
    "interaction": {
        "free_intrinsics": ["v", "a", "z", "tau", "s_v", "s_tau"],
        "fixed_intrinsics": [],
...
def test(case: str):
    ...
    masks = ddm_samples["masks"]
    params = ddm_samples["params"]
...
def main(
    ...
    checkpoint_path = f"./cogformer/experiments/checkpoints/ddm_families_bf_{case}"
