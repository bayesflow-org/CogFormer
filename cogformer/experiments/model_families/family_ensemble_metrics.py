...
from cogformer.diagnostics.plot.ensemble_metrics import ensemble_metrics
...
def main():
    ...
    design_configs = [
        cm.build_random_design_config(
            ...
            free_intrinsics=reg["free_params"],
            fixed_intrinsics=reg["fixed_params"],
            keep_intercept=args.keep_intercept,
            add_interaction=args.add_interaction,
        )
    ...
    fig_path = outdir / f"{fig_stem}_ensemble_metrics.pdf"
