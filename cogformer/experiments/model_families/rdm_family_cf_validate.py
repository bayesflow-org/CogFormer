...
def parse_args():
    ...
    p.add_argument("--outdir", type=str, default="./cogformer/experiments/figures/fm/rdm/", help="Output directory")
...
def test(case="fixed"):
    ...
    data_path = Path(f"cogformer/experiments/data/rdm_{case}_data.npz")
...
def main():
    ...
    for cfg_name, design_config in benchmark.items():
        ...
        pred_path = pred_dir / f"rdm_families_{cfg_name}_cf_pred.npz"
...
if __name__ == "__main__":
    ...
    # To use
    # python -m rdm_family_cf_validate.py \
    # --checkpoint cogformer_rdm_fm_eps500_stp200_bse32_nls4_nhs8_nss10.pt \
    # --batch_size 200 \
