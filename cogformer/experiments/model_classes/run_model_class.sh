...
CKPT_DIR="./cogformer/experiments/checkpoints/fm/model_class"
CKPT="${CKPT_DIR}/${CKPT_NAME}"

OUTDIR="./cogformer/experiments/figures/fm/model_class"
PRED_DIR="./cogformer/experiments/data/model_class"

# ============================================================
# Step 1: Train
# ============================================================
echo "=== [1/2] Training ModelClass CF ==="
...
# Step 2: Validate
# ============================================================
echo "=== [2/3] Validating ModelClass CF ==="
python -m cogformer.experiments.model_classes.model_class_cf_validate \
    --checkpoint          "$CKPT" \
    --outdir              "$OUTDIR" \
    --pred_dir            "$PRED_DIR" \
...
#python -m cogformer.experiments.model_classes.model_class_ensemble_eval \
#    --checkpoint          "$CKPT" \
...
#python -m cogformer.experiments.model_classes.model_class_ensemble_metrics \
#    --checkpoint          "$CKPT" \
#    --outdir              "$ENSEMBLE_OUTDIR" \
#    --encoder_num_layers  "$ENCODER_LAYERS" \
#    --decoder_num_layers  "$DECODER_LAYERS" \
