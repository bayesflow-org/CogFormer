...
def main():
    ...
    parser.add_argument(
        "--with_embed_dir",
        type=str,
        default="./cogformer/experiments/figures/fm/model_class",
        help="Output directory from validate run with model embedding",
    )
    parser.add_argument(
        "--no_embed_dir",
        type=str,
        default="./cogformer/experiments/figures/fm/model_class_no_embed",
        help="Output directory from validate run without model embedding",
    )
    parser.add_argument(
        "--out_dir",
        type=str,
        default="./cogformer/experiments/model_classes/embedding_ablation_data",
